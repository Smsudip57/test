    ...
    <div className="min-h-max py-20 lg:py-[150px]">
      <div className="mx-auto mb-20 lg:mb-0 bg-white max-w-[1536px]  flex-col items-center">
        ...
        {context.user && !context.loading ? (
          <button
            className="bg-[#446E6D] text-white flex items-center rounded-md font-semibold gap-2 cursor-pointer w-max mt-8 text-lg hover:bg-[#385b5a] transition-colors justify-center mx-auto relative z-40 py-3 px-7"
            onClick={() => {
