    ...
    <div className='pt-16' id="read more">
      <div className='w-full grid justify-center'>
        ...
        <div className='w-[1320px] mx-auto flex items-start z-20 gap-7'>
            <p className='w-full mb-20 text-gray-500 ' style={{lineHeight:"35px"}}>
            <span className='text-2xl text-black'>Privacy Policy for WEBME Information Technology Consultancy</span><br/>
            At WEBME Information Technology Consultancy, accessible from webmedigital.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by WEBME Information Technology Consultancy and how we use it.<br/>
            If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.<br/>
            This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in WEBME Information Technology Consultancy. This policy is not applicable to any information collected offline or via channels other than this website. Our Privacy Policy was created with the help of the H-supertools Privacy Policy Generator.<br/>
            Consent<br/>
            ...
            You may consult this list to find the Privacy Policy for each of the advertising partners of WEBME Information Technology Consultancy.<br/>
            Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on WEBME Information Technology Consultancy, which are sent directly to users&apos; browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.<br/>
            Note that WEBME Information Technology Consultancy has no access to or control over these cookies that are used by third-party advertisers.<br/>
