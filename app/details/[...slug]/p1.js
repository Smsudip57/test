    ...
    <div className='min-h-screen min-w-screen text-center relative  font-sans'>
        <div className='flex min-h-screen'> 
            <div className='basis-1/2 min-h-full  pt-16 flex flex-col justify-center items-start text-start px-[10%] gap-10'>
             <h1 className='text-6xl font-semibold text-[#446E6D]'>CAFM System for Mountain Gate Property ManagementClient</h1>
             <p className='text-xl font-sans'>We developed a comprehensive CAFM system tailored to the needs of Mountain Gate Property Management. This project involved creating a robust platform to manage property portfolios efficiently, automate maintenance tasks, and streamline operations across multiple properties.</p>
