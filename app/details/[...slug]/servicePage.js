...
export default function Page({ details: Service, type }) {
  ...
  return (
    <div className="min-h-screen min-w-screen text-center relative font-sans">
      ...
      {Service?.childServices && Service.childServices.length > 0 && (
        <div className="mt-20">
          <RelatedProducts relatedProducts={Service.childServices} />
        </div>
      )}

      <div className="w-[90%] mx-auto lg:w-full">
        <CaseStudy data={Service?.relatedTestimonials} />
      </div>
      ...
      <div className="mx-auto min-h-screen flex justify-center items-center">
        {type === "parent" ? (
          <BlogSection data={Service?.relatedBlogs} />
        ) : (
          <KnowledgeBase data = {Service?.relatedKnowledgeBase} />
        )}
      </div>

      {/* FAQ Section Component */}
      <FaqSection data={Service?.relatedFaqs} />
      <section
      ...
      >
        ...
        <Industies industries={Service?.relatedIndustries} />
      </section>
