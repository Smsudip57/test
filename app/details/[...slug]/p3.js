    ...
    <div className='min-h-screen min-w-screen text-center relative  font-sans'>
        <div className='flex min-h-screen'> 
            <div className='basis-1/2 min-h-full  pt-16 flex flex-col justify-center items-start text-start px-[10%] gap-10'>
             <h1 className='text-6xl font-semibold text-[#446E6D]'>project-image
             Website Development for The Design District</h1>
             <p className='text-xl font-sans'>We developed a state-of-the-art website for The Design District, aimed at enhancing their online presence and providing a seamless user experience. The project focused on creating a visually stunning and highly functional website that reflects the brand’s identity and meets the needs of their clients.</p>
