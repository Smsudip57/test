    ...
    <div className='min-h-screen min-w-screen text-center relative  font-sans'>
        <div className='flex min-h-screen'> 
            <div className='basis-1/2 min-h-full  pt-16 flex flex-col justify-center items-start text-start px-[10%] gap-10'>
             <h1 className='text-6xl font-semibold text-[#446E6D]'>Fortify Your Digital Fortress with Our Network Security Solutions</h1>
             <p className='text-xl font-sans'>Stay one step ahead of cyber threats with our cutting-edge network security services.

From advanced firewall management to real-time intrusion detection and thorough vulnerability assessments, we ensure your digital assets are impenetrable. Protect your business with our robust, proactive security measures and enjoy peace of mind knowing your network is secure.</p>
