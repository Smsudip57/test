    ...
    <div className='min-h-screen min-w-screen text-center relative  font-sans'>
        <div className='flex min-h-screen'> 
            <div className='basis-1/2 min-h-full  pt-16 flex flex-col justify-center items-start text-start px-[10%] gap-10'>
             <h1 className='text-6xl font-semibold text-[#446E6D]'>Microsoft 365 Implementation for Alqodorat General Contracting Client</h1>
             <p className='text-xl font-sans'>We successfully implemented Microsoft 365 for Alqodorat General Contracting to enhance their productivity, collaboration, and communication across the organization. This project aimed to provide a modern, integrated cloud-based solution that meets the company’s operational needs and supports its growth.</p>
