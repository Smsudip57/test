    ...
    <div className='min-h-screen min-w-screen text-center relative  font-sans'>
        <div className='flex min-h-screen'> 
            <div className='basis-1/2 min-h-full  pt-16 flex flex-col justify-center items-start text-start px-[10%] gap-10'>
             <h1 className='text-6xl font-semibold text-[#446E6D]'>Transforming Efficiency: AL SAHRA Recruitement Services IT Revolution with WEBME</h1>
             <p className='text-xl font-sans'>AL SAHRA Recruitment Services, a prominent player in the recruitment and staffing industry, needed a robust and scalable IT infrastructure to support their expanding operations. They sought a comprehensive IT consultancy service to enhance their cloud capabilities, improve communication systems, and ensure top-notch security.</p>
        ...
        <div className='my-24'>
          <div className='w-4/5 mx-auto flex justify-between gap-[15%]'>
            ...
            <img src='/bwb.jpg' width={100} className='w-full '/>
            </div>
