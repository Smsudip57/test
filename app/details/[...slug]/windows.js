    ...
    <div className='min-h-screen min-w-screen text-center relative  font-sans'>
        <div className='flex min-h-screen'> 
            <div className='basis-1/2 min-h-full  pt-16 flex flex-col justify-center items-start text-start px-[10%] gap-10'>
             <h1 className='text-6xl font-semibold text-[#446E6D]'>Windows Virtual Desktop</h1>
             <p className='text-xl font-sans'>Unlock the full potential of remote work with Windows Virtual Desktop. Seamlessly access your desktop and applications from any device, anywhere in the world. Experience unparalleled security, scalability, and productivity with a cloud-based solution designed to keep your business agile and efficient. Transform the way you work with Windows Virtual Desktop – where your office is wherever you are.</p>
