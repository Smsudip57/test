  ...
  const handleSubmit = async (e) => {
    ...
    const createProduct = async () => {
      ...
      try {
        ...
        customToast({ success: true, message: 'Product created successfully!' });
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <select
                        id="service"
                        name="service"
                        value={productData.service}
                        onChange={handleInputChange}
                        disabled={!productData.category}
                        className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white shadow-sm disabled:bg-gray-100 disabled:text-gray-500"
                      >
                      ...
                      {noServicesMessage && (
                        <p className="mt-1 text-sm text-red-500">{noServicesMessage}</p>
                      )}
                    </div>
                  </div>
                </div>
