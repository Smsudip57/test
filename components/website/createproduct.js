...
export default function CreateChildService() {
        ...
        <div className="max-w-6xl mx-auto">
          <header className="flex items-center justify-between mb-8 bg-white p-6 rounded-xl shadow-sm">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className={`flex items-center px-6 py-3 rounded-lg text-white font-medium ${loading
                  ? "bg-[#446E6D]/70"
                      ...
                      >
                        <div className="flex flex-col items-center justify-center py-8">
                          ...
                          <p className="text-base font-medium text-[#446E6D] mb-1">
                            Click to upload Child Service image (16:9)
                          </p>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      ...
                      URLs: /childservice/{productData.slug || "example-slug"}
                    </p>
                  </div>
