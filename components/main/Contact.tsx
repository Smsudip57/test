      ...
      <div className="border border-[#00CAB7] rounded-xl flex flex-col sm:flex-row justify-between">
        <div className="p-3 sm:p-8 gap-5 flex flex-col">
          ...
          <div className="flex flex-col gap-2">
            <h1 className="font-lora text-2xl lg:text-4xl leading-[34px] text-[#282828] font-bold">
              Connect WEBME
            </h1>
            <p className="font-graphik text-sm font-normal text-darkblack-700">
              Subscribe for Exclusive Updates
            </p>
          </div>
          <button
            className="border border-[#00CAB7] rounded-md px-[22px] py-[13px] text-base font-semibold text-[#00CAB7]"
            onClick={handlemail}
          >
            Get started
          </button>
